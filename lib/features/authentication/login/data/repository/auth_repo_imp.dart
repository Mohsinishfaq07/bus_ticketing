...
import 'package:sb_myreports/features/authentication/login/data/models/sign_up_response_model.dart';
import 'package:sb_myreports/features/authentication/login/data/models/sign_up_request_model.dart';
...
class LoginRepoImp extends AuthRepository {
  ...
  Future<Either<Failure, SignupResponseModel>> signupUser(
    ...
    try {
      return Right(await remoteDataSource.signupUser(params));
    } on Failure catch (e) {
      return Left(e);
    } catch (e) {
      return Left(ServerFailure(e));
